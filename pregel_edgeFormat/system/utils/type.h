...
struct longpair {
    ...
    longpair(long long v1, long long v2)
    {
        this->v1 = v1;
        this->v2 = v2;
    }
    
    void set(long long v1, long long v2)
    {
        this->v1 = v1;
        this->v2 = v2;
    }
    
    inline bool operator<(const longpair& rhs) const
    {
        return (v1 < rhs.v1) || ((v1 == rhs.v1) && (v2 < rhs.v2));
    }
    ...
    long long hash()
    {
        ...
        hash_combine(seed, v1);
        hash_combine(seed, v2);
        return seed % ((unsigned long long)_num_workers);
    }
};

ibinstream& operator<<(ibinstream& m, const longpair& v)
{
    m << v.v1;
    m << v.v2;
    return m;
...
obinstream& operator>>(obinstream& m, longpair& v)
{
    m >> v.v1;
    m >> v.v2;
    return m;
...
class LongPairHash {
public:
    inline long long operator()(longpair key)
    {
        return key.hash();
    }
};
...
namespace __gnu_cxx {
    template <>
    struct hash<longpair> {
        size_t operator()(longpair pair) const
        {
            size_t seed = 0;
            hash_combine(seed, pair.v1);
            hash_combine(seed, pair.v2);
